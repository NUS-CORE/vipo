...
## VIPO integration
VIPO is now integrated into OfflineRL-Kit. Use the following dynamics implementations:
- AntMaze tasks: `OfflineRL-Kit/offlinerlkit/dynamics/vipo_ensemble_dynamics.py`
- Gym tasks: `OfflineRL-Kit/offlinerlkit/dynamics/vipo_ensemble_dynamics_exp.py` (recommended for stable training)
