...
from offlinerlkit.dynamics import VIPOEnsembleDynamics_EXP
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="mopo_vipo_exp")
    ...
    parser.add_argument("--vipo-phi", type=float, default=1e-4)
    parser.add_argument("--vipo-value-hidden-dims", type=int, nargs='*', default=[256, 256, 256])
    parser.add_argument("--vipo-value-lr", type=float, default=3e-4)
    parser.add_argument("--vipo-adv-norm", type=bool, default=False)
...
def train(args=get_args()):
    ...
    dynamics = VIPOEnsembleDynamics_EXP(
        dynamics_model,
        dynamics_optim,
        scaler,
        termination_fn,
        ...
        discount=args.gamma,
        phi=args.vipo_phi,
        value_hidden_dims=args.vipo_value_hidden_dims,
        value_lr=args.vipo_value_lr,
        advantage_normalization=args.vipo_adv_norm,
    )
    ...
    log_dirs = make_log_dirs(
        ...
        args.seed,
        vars(args),
        record_params=["penalty_coef", "rollout_length", "vipo_phi"]
    )
