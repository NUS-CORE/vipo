...
from offlinerlkit.dynamics import VIPOEnsembleDynamics
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="mopo_vipo")
    ...
    parser.add_argument("--vipo-value-hidden-dims", type=int, nargs='*', default=[256, 256])
